...
const Footer = () => {
  return (
    <div className="w-full h-3/5 p-12 bg-slate-900 flex justify-center items-center  ">
      <div className="w-full  md:w-3/4 md:h-3/4 flex flex-col md:flex-row">
        <div className="  md:w-1/4  flex flex-col items-center justify-between md:p-8 text-white">
        ...
        <div className=" flex md:flex-row w-80  md:w-full">
          <div className="w-1/3 gap-2 md:w-1/4 flex flex-col md:gap-4 items-center text-gray-200 p-8 md:p-2">
          ...
          <div className=" w-1/3 gap-2 md:w-1/4 md:flex flex-col md:gap-4 items-center text-gray-200 p-8 md:p-2">
